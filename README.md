...
- 疾病/适应症：1 个，待完成公开资料可得性评估后确定。
- 比较企业：2 家，要求均具有可核验的公开研发资料。
- 临床试验：计划整理 10–20 条。
- 医学论文：计划整理 10–20 篇。
- 监管信息：计划整理 5–10 条。
...
稳定开发分支为 `competition-2026-xinjiang`。成员从稳定分支创建独立功能分支，通过 Pull Request 合并，避免直接同时修改稳定分支。API 密钥、虚拟环境、本地数据库、大型原始资料和运行日志不得提交到仓库。
